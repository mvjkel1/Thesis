import { Appointments, AppointmentTooltip, ConfirmationDialog,  MonthView,
  Toolbar,
...
export const Calendar = () => {
  ...
  const commitChanges = (({added, changed, deleted}) => {
    if(deleted !== undefined){
      deleteEvent(currentWorkgroup?._id, deleted, token)
      .then(() => dispatch(getEvents(currentWorkgroup, token)))
    }
  })
