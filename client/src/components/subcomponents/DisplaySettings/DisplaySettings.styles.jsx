import { Box, styled, Typography, Badge, Switch } from '@mui/material';
...
export const DndSwitch = styled(Switch)(({ theme }) => ({
  width: 62,
  height: 34,
  padding: 7,
  '& .MuiSwitch-switchBase': {
  ...
  '& .MuiSwitch-thumb': {
    ...
    '&:before': {
      ...
      top: 0,
      backgroundRepeat: 'no-repeat',
      backgroundPosition: '42% 48%',
      backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 20 20"><path fill="${encodeURIComponent(
        '#fff'
      )}" d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" /></svg>')`
    }
  },
  '& .MuiSwitch-track': {
    opacity: 1,
